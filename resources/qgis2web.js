...
map.getView().fit([8905271.784431, 1445636.219351, 8989798.451598, 1487612.047263], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Women Safety Study - Pedestrian Crossing</h2>';
        return titleElement;
    })(),
